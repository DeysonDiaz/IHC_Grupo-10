...
class _MyHomePage extends State<MyHomePage> {
  ...
  FocusNode namesFocus, lastNamesFocus, birthDayFocus, birthMonthFocus, birthYearFocus;
      ...
      body: Container(
        ...
        child: Center(
          child: Form(
            ...
            child: ListView(
              children: <Widget>[
                Text('Ingrese sus datos:', style: TextStyle(fontSize: 16), textAlign: TextAlign.center,),
                TextFormField(
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(labelText: 'Día de nacimiento:'),
                  ...
                  validator: (value) {
                    ...
                    if(day == null || day < 1 || 31 < day) return 'Dato inválido';
                    return null;
                  },
                  onEditingComplete: () {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if(month == null || month < 1 || 12 < month) return 'Dato inválido';
                    return null;
                  },
                  onEditingComplete: () {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if(year == null || year < 1 || 2020 < year) return 'Dato inválido';
                    return null;
                  },
                ),
                SizedBox(height: 10),
