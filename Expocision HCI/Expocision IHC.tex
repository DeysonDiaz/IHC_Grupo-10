...
\frametitle{Educacion Inclusiva: Principios Basicos}
    ...
    \includegraphics[width=4.5cm, height=6cm]{educacion-inclusiva01.jpg} 
    \end{minipage}
...
\frametitle{Educacion Inclusiva: Principios Basicos}
    \justify
    \begin{minipage}[c]{0.4\textwidth} 
    \includegraphics[width=4.5cm, height=6cm]{tipos-de-discapacidad.jpg} 
    \end{minipage}
    \begin{minipage}[c]{0.55\textwidth}
    Discapacidad
        \begin{itemize}
...
\frametitle{Capacidades Diferenciadas}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{capacidades-diferenciadas.jpg} 
    \end{figure}
\end{frame}
...
\frametitle{Brecha Digital en el Déficit de Aprendizaje}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{brecha-digital-deficit-aprendizaje.jpg} 
    \end{figure}
\end{frame}
...
\frametitle{USAER (Unidad de Servicio de Apoyo a la Educacion Regular)}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{usaer.jpg} 
    \end{figure}
\end{frame}
...
\frametitle{USAER (Unidad de Servicio de Apoyo a la Educacion Regular)}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{usaer-cuadro.jpg} 
    \end{figure}
\end{frame}
...
\frametitle{USAER (Unidad de Servicio de Apoyo a la Educacion Regular)}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{usaer-explicacion.jpg} 
    \end{figure}
\end{frame}
...
\frametitle{¿Como ayudar al maestro?}
    \justify
    \begin{minipage}[c]{0.4\textwidth} 
    \includegraphics[width=4.5cm, height=6cm]{profesor-ensenando.jpg} 
    \end{minipage}
    \begin{minipage}[c]{0.55\textwidth}
...
\frametitle{¿Como asistir a los niños con Educacion Inclusiva?}
    \justify
    \begin{minipage}[c]{0.4\textwidth} 
    \includegraphics[width=4.5cm, height=6cm]{pintando.jpg} 
    \end{minipage}
    \begin{minipage}[c]{0.55\textwidth}
        \begin{itemize}
...
\frametitle{Participantes en el aprendizaje inclusivo de los niños}
    \justify
    \begin{minipage}[c]{0.4\textwidth} 
    \includegraphics[width=4.5cm, height=6cm]{ImagenMateBas1.png} 
    \end{minipage}
    \begin{minipage}[c]{0.55\textwidth}
...
\frametitle{Perfil de usuario}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas2.png}
    \end{figure}
\end{frame}
...
\frametitle{Diagnóstico}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas3.png}
    \end{figure}
\end{frame}
...
\frametitle{Repositorio de recursos educativos en matemáticas básicas}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas4.png}
    \end{figure}
\end{frame}
...
\frametitle{Prueba de uso de aplicación educativa}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas5.png}
    \end{figure}
\end{frame}
...
\frametitle{Requerimientos de nuevas aplicaciones educativas}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas6.png}
    \end{figure}
\end{frame}
...
\frametitle{Prototipos}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas7.png}
    \end{figure}
\end{frame}
...
\frametitle{Prototipos}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas8.png}
    \end{figure}
\end{frame}
...
\frametitle{Aplicaciones educativas para matemáticas básicas}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas9.png}
    \end{figure}
\end{frame}
...
\frametitle{Capacitación docente}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas10.png}
    \end{figure}
\end{frame}
...
\frametitle{Resultados}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas11.png}
    \end{figure}
\end{frame}
...
\frametitle{Resultados}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas12.png}
    \end{figure}
\end{frame}
...
\frametitle{Resultados}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas13.png}
    \end{figure}
\end{frame}
...
\frametitle{Resultados}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas14.png}
    \end{figure}
\end{frame}
...
\frametitle{Resultados}
    \begin{figure}
    \centering
     \includegraphics[width=0.8\textwidth]{ImagenMateBas15.png}
    \end{figure}
\end{frame}
